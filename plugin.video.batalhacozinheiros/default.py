...
AddonID = 'plugin.video.batalhacozinheiros'
...
addon_data_dir = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.batalhacozinheiros/data" ).decode("utf-8"), AddonID)
