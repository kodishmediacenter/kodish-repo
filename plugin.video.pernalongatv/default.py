...
AddonID = 'plugin.video.pernalongatv'
...
addon_data_dir = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.pernalongatv/data" ).decode("utf-8"), AddonID)
