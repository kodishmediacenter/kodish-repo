...
vimeo00Url="spotify:user:spotifybrazilian:playlist:0aov2ohgqhD0K88L8cOsvw"
...
def index():
    ...
    addDir("Rodar Spotify =>", vimeo00Url, 'showSite', os.path.join(addonPath, "spotify.png"), "yes", "yes")
