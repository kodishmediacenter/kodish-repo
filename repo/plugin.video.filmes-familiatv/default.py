...
AddonID = 'plugin.video.filmes-familiatv'
...
addon_data_dir = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.filmes-familiatv/data" ).decode("utf-8"), AddonID)
